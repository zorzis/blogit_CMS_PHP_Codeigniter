...
//so for call index.php i write 4 up directory -> ../../../../
//include('../../../../index.php');
...
if($CI->session->userdata('upload_image_file_manager') == TRUE)
{
...
/** That's the default session checker for php.We have changed it to use CI session manager.**/
