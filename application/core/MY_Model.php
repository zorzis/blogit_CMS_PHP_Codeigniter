...
*   You can overwrite this functionality by setting the $primary_key instance variable:
*   class Post_model extends MY_Model
*   {
...
class MY_Model extends CI_Model
{
    ...
    /**
     * Set _logevents to FALSE by default, and if found to true,
     * store timestamps (created,modified) found on save or 
     * update functions, same with created_by and modified_by storing 
    ...
    {
        // Set timestamps and created_by field based on Flexi Auth call to library 
