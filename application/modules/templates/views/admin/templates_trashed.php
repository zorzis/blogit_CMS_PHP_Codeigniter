				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
												...
												<span class="label <?php echo ($template->deleted == 1) ? "bg-dark" : "";?>"> <?php echo ($template->deleted == 1) ? "Trashed" : "";?> </span>
											...
											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/templates/unset_trashed_template/<?php echo $template->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Unset Template From Trashed"><i class="fa fa-circle text-success"></i></a>
											</td>
											...
											<td>
				                        		<a onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" href="<?php echo base_url(); ?>admin/templates/delete_trashed_template/<?php echo $template->id ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
											</td>
				                ...
				                <footer class="panel-footer">
				                  <div class="row">
				                    ...
				                    <div class="col-sm-4 text-left">
				                      <span> <h4><?php echo $this->lang->line('total_templates');?> <span class="badge bg-dark"><?php echo $total_trashed_templates; ?></span> </h4></span>
				                    </div>
