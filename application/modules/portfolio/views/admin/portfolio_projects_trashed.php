              ...
              <div class="m-b-md">
				...
				<section class="panel panel-default">
				                <header class="panel-heading">
				                  <i class="fa fa-bars fa-2x"> <?php echo $this->lang->line('trashed_portfolio_projects');?></i>
				                </header>
				                  ...
				                  <table class="table table-striped b-t b-light">
				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
				                        		<a onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" href="<?php echo base_url(); ?>admin/portfolio/delete_trashed_portfolio_project/<?php echo $project->id ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
											</td>
