          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('manage_menus');?></h3>
              </div>
				                  ...
				                  <table class="table table-striped b-t b-light">
				                    <thead>
				                      <tr>
				                        ...
				                        <th><?php echo $this->lang->line('menu_is_global');?></th>
				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
												...
												<span class="label <?php echo ($menu->is_published == 1) ? "bg-success" : "bg-danger";?>"> <?php echo ($menu->is_published == 1) ? "Published" : "Unpublished";?> </span>
											...
											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/menus/unpublish_menu/<?php echo $menu->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Unpublish"><i class="fa fa-circle text-danger"></i></a>
											</td>

											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/menus/delete_menu/<?php echo $menu->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Trash"><i class="fa fa-trash-o text-warning"></i></a>
											</td>
