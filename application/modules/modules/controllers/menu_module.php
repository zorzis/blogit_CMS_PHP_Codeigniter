...
class Menu_module extends Backend_Controller
{
	...
	public function create ()
	{
        ...
        $this->form_validation->set_rules('choose_menu','Choose Menu','integer|required');

		if($this->form_validation->run() == FALSE){ 

			//Get Menus
			$this->data['menus'] = $this->menu_m->get_menus();
			...
			//{
				...
				$this->data['path_to_menu_module_layouts'] = APPPATH . 'views/themes/' . $default_template_name . '/modules_layouts/menu_modules';
				$extensions = array('php');

				$this->data['menu_module_layouts'] = get_filenames_by_extension($this->data['path_to_menu_module_layouts'], $extensions);
			...
			$this->data['message'] = (! isset($this->data['message'])) ? $this->session->flashdata('message') : $this->data['message'];		
       		...
       		// Load the view
			$this->load->view('modules/admin/module_menu_create', $this->data);
		} 
			...
			$data = array(
				...
				'module_type' 		=> 'menu_module', //menu module content
			...
			$data = array(
				...
				'menu_id'					=> $this->input->post('choose_menu'),
			); 

			//Custom Module Insert
	        $this->module_m->add_module_menu($data);


			$this->session->set_flashdata('message', '<p>Menu Module Created Succesfully!</p>');
	...
	public function update ($module_id = NULL)
	{
		...
		{ 
			...
			$this->data['module'] = $this->module_m->get_menu_module($module_id);
			...
			// Load the view
			$this->load->view('modules/admin/module_menu_update', $this->data);
		}
	        ...
	        $this->module_m->update_module_menu_content($data);
