...
class Popular_articles_module extends Backend_Controller
{
	...
	public function create ()
	{
		...
		{ 
			...
			//{
				...
				$this->data['path_to_popular_articles_blog_module_layouts'] = APPPATH . 'views/themes/' . $default_template_name . '/modules_layouts/blog_modules/popular_articles';
				$extensions = array('php');
				//
				$this->data['blog_module_layouts'] = get_filenames_by_extension($this->data['path_to_popular_articles_blog_module_layouts'], $extensions);
			...
			$this->data['message'] = (! isset($this->data['message'])) ? $this->session->flashdata('message') : $this->data['message'];		
       		...
       		// Load the view
			$this->load->view('modules/admin/module_popular_articles_create', $this->data);
		} 
			...
			$data = array(
				...
				'module_type' 				=> 'popular_blog_articles_module', //popular blog articles module content
			...
			$this->session->set_flashdata('message', '<p>Popular Articles Module Created Succesfully!</p>');
	...
	public function update ($module_id = NULL)
	{
		...
		{ 
			...
			$this->data['module'] = $this->module_m->get_popular_articles_module($module_id);
			...
			// Load the view
			$this->load->view('modules/admin/module_popular_articles_update', $this->data);
		}
			...
			$this->session->set_flashdata('message', '<p>Popular Articles Module Updated Succesfully!</p>');
