        ...
        <a href="<?php echo base_url(); ?>admin/modules/" class="hidden-xs btn btn-sm btn-info"><i class="fa fa-tasks fa-2x"></i> <?php echo $this->lang->line('modules');?></a>
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('create_custom_module');?></h3>
              </div>   
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-info"><?php echo $this->lang->line('create_custom_module');?></div>
                      </div>                      
                    </div>
                  </div>
                  ...
                  <div class="panel-body">
                    <div class="tab-content"><!--Starts Tab Content -->
                      ...
                      <div class="tab-pane fade active in" id="module_content"><!--Starts Module Content Tab Content -->
                        ...
                        <div class="form-group">
                          <label><?php echo $this->lang->line('module_content');?></label>
                          <textarea id="editor1" name="module_body" placeholder="<?php echo $this->lang->line('module_content_placeholder');?>"><?php echo set_value('content');?></textarea>
                        </div>
                      ...
                      <div class="tab-pane fade" id="module_layout_settings"><!-- Starts Access Settings Panel -->
                          ...
                          <div class="form-group">
                            ...
                            <select name="module_layout" id="module_layout" class="form-control input-lg m-b">
                              ...
                              <?php foreach ($custom_module_layouts as $custom_module_layout) : ?>

                              <option value="<?php echo $custom_module_layout; ?>"

                                <?php if($custom_module_layout == 'default_custom_module_layout.php') : ?>
