        ...
        <a href="<?php echo base_url(); ?>admin/modules/" class="hidden-xs btn btn-sm btn-info"><i class="fa fa-tasks fa-2x"></i> <?php echo $this->lang->line('modules');?></a>
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('create_menu_module');?></h3>
              </div>   
              ...
              <div class="col-lg-4">
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-info"><?php echo $this->lang->line('create_menu_module');?></div>
                      </div>                      
                    </div>
                  </div>
                ...
                <a class="btn btn-info btn-lg btn-block" href="#choose_menu" data-toggle="tab">
                ...
                <section>
                  <div class="panel-body">
                    <div class="tab-content"><!--Starts Tab Content -->
                      ...
                      <div class="tab-pane fade active in" id="choose_menu"><!--Starts Module Content Tab Content -->

                        <section class="panel panel-default">
                          <header class="panel-heading bg-warning lt no-border font-bold">
                            <i class="fa fa-bars fa-2x"> Choose Menu</i>
                          </header>
                        </section>
                        ...
                        <div class="form-group">
                          ...
                          <label><?php echo $this->lang->line('module_choose_menu');?></label>

                          <select name="choose_menu" id="choose_menu" class="form-control input-lg m-b">
                      ...
                      <div class="tab-pane fade" id="module_layout_settings"><!-- Starts Access Settings Panel -->
                          ...
                          <div class="form-group">
                            ...
                            <select name="module_layout" id="module_layout" class="form-control input-lg m-b">
                              ...
                              <?php foreach ($menu_module_layouts as $menu_module_layout) : ?>

                              <option value="<?php echo $menu_module_layout; ?>"

                                <?php if($menu_module_layout == 'default_menu_module_layout.php') : ?>
