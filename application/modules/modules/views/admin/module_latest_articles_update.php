        ...
        <a href="<?php echo base_url(); ?>admin/modules/" class="hidden-xs btn btn-sm btn-info"><i class="fa fa-tasks fa-2x"></i> <?php echo $this->lang->line('modules');?></a>
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('update_blog_module_latest_articles');?></h3>
              </div>   
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-dark"><?php echo $this->lang->line('blog_module_latest_articles');?></div>
                      ...
                      <div class="tab-pane fade active in" id="module_content"><!--Starts Module Content Tab Content -->
                        ...
                        <section class="panel panel-default">
                          <header class="panel-heading bg-info lt no-border font-bold">
                            <i class="fa fa-bars fa-2x"> Limit Latest Articles </i>
                          </header>
                        </section>

                        <div class="form-group">
                          <label>Number of Latest Articles to be shown</label>
