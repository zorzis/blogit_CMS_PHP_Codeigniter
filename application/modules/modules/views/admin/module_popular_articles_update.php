        ...
        <a href="<?php echo base_url(); ?>admin/modules/" class="hidden-xs btn btn-sm btn-info"><i class="fa fa-tasks fa-2x"></i> <?php echo $this->lang->line('modules');?></a>
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('update_blog_module_popular_articles');?></h3>
              </div>   
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-dark"><?php echo $this->lang->line('blog_module_popular_articles');?></div>
                      ...
                      <div class="tab-pane fade active in" id="module_content"><!--Starts Module Content Tab Content -->
                        ...
                        <section class="panel panel-default">
                          <header class="panel-heading bg-info lt no-border font-bold">
                            <i class="fa fa-bars fa-2x"> Limit Popular Articles </i>
                          </header>
                        </section>

                        <div class="form-group">
                          <label>Number of Popular Articles to be shown</label>
                          <div id="limit_articles_number" class="spinner input-group" data-min="1" data-max="25">
                            <input type="text" class="form-control spinner-input" value="<?php echo set_value('limit_articles_number',$module->limit_articles_number);?>" name="limit_articles_number" maxlength="3">
                        ...
                        <!-- Starts  blog_module/popular_articles Content Tab -->
                        <section class="panel panel-default">

                          <header class="panel-heading bg-warning lt no-border font-bold">
                            <i class="fa fa-bars fa-2x"> Assign Blog Categories </i>
                          </header>
                            ...
                            <table class="table table-striped b-t b-light">
                              <thead>
                                <tr>
                                  ...
                                  <th>Blog Cateogory</th>
                                  <th>Assign Blog Category's Articles to Module</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    $current_status = (in_array($category->id, $current_blog_module_categories)) ? 1 : 0; 
                                    $new_status = (in_array($category->id, $current_blog_module_categories)) ? 'checked="checked"' : NULL;
                    ...
                    <div class="tab-pane fade" id="module_layout_settings"><!-- Starts Access Settings Panel -->
                          ...
                          <div class="form-group">
                            ...
                            <select name="module_layout" id="module_layout" class="form-control input-lg m-b">
                              ...
                              <?php foreach ($blog_module_layouts as $blog_module_layout) : ?>

                              <option value="<?php echo $blog_module_layout; ?>"

                                <?php if($blog_module_layout == $module->module_layout) : ?>
