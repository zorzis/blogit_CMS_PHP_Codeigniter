        ...
        <a href="<?php echo base_url(); ?>admin/modules/" class="hidden-xs btn btn-sm btn-info"><i class="fa fa-tasks fa-2x"></i> <?php echo $this->lang->line('modules');?></a>
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('update_menu_module');?></h3>
              </div>   
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-dark">Menu Modules</div>
                ...
                <section>
                  <div class="panel-body">
                    <div class="tab-content"><!--Starts Tab Content -->
                      ...
                      <div class="tab-pane fade active in" id="module_content"><!--Starts Module Menu Tab Content -->
                  ...
                  </div><!-- Ends Module Menu Content Tab -->
                  ...
                  <div class="tab-pane fade" id="module_settings"><!--Starts Module Settings Tab Content -->
                    ...
                    </div><!-- Ends Template Position Settings Panel -->
                          ...
                          <div class="form-group">
                            ...
                            <select name="module_layout" id="module_layout" class="form-control input-lg m-b">
                              ...
                              <option value="<?php echo $menu_module_layout; ?>"
                                ...
                                <?php if($menu_module_layout == $module->module_layout) : ?>
