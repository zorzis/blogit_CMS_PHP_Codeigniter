          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('manage_trashed_modules');?></h3>
              </div>
				                  ...
				                  <table class="table table-striped b-t b-light">
				                    <thead>
				                      <tr>
				                        ...
				                        <th><?php echo $this->lang->line('module_is_global');?></th>
				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
												...
												<span> <?php echo ($module->is_global == 1) ? "Yes" : "No";?> </span>

											</td>

											<td>
												<span class="label <?php echo ($module->deleted == 1) ? "bg-dark" : "";?>"> <?php echo ($module->deleted == 1) ? "Trashed" : "";?> </span>
											...
											<td>
				                        		<a onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" href="<?php echo base_url(); ?>admin/modules/delete_trashed_module/<?php echo $module->id ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
