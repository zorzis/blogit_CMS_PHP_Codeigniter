          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('manage_blog_articles');?></h3>
              </div>
				                  ...
				                  <table class="table table-striped b-t b-light">
				                    <thead>
				                      <tr>
				                        ...
				                        <th><?php echo $this->lang->line('blog_article_views_counter');?></th>
				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
												...
												<span class="label <?php echo ($article->is_published == 1) ? "bg-success" : "bg-danger";?>"> <?php echo ($article->is_published == 1) ? "Published" : "Unpublished";?> </span>
											...
											<td>
												<span class="label bg-warning">
													...
													<?php echo $article->views_counter ?>
											...
											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/blog/unpublish_blog_article/<?php echo $article->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Unpublish"><i class="fa fa-circle text-danger"></i></a>
											</td>

											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/blog/delete_blog_article/<?php echo $article->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Trash"><i class="fa fa-trash-o text-warning"></i></a>
											</td>
				                ...
				                <footer class="panel-footer">
				                  <div class="row">
				                    ...
				                    <div class="col-sm-4 text-left">
				                      <span> <h4><?php echo $this->lang->line('total_articles');?><span class="badge bg-dark"><?php echo $total_articles; ?></span> </h4></span>
				                    </div>
