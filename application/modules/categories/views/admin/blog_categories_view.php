          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('manage_blog_categories');?></h3>
              </div>
				                  ...
				                  <table class="table table-striped b-t b-light">
				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/blog/categories/unpublish_blog_category/<?php echo $category->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Unpublish"><i class="fa fa-circle text-danger"></i></a>
											</td>

											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/blog/categories/delete_blog_category/<?php echo $category->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Trash"><i class="fa fa-trash-o text-warning"></i></a>
											</td>
