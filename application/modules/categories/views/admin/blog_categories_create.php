          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('create_blog_category');?></h3>
              </div>   
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-info"><?php echo $this->lang->line('create_blog_category');?></div>
                      </div>                    
                    </div>
                  </div>
                  ...
                  <div class="tab-content"><!--Starts Tab Content -->
                    ...
                    <div class="tab-pane fade active in" id="blog_category"><!--Starts Article Tab Content -->
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="category_title" name="category_title" value="<?php echo set_value('category_title');?>" class="form-control input-lg m-b" placeholder="<?php echo $this->lang->line('blog_category_title_placeholder');?>">
                      </div>
                      <div class="line line-dashed line-lg pull-in"></div>

                      <div class="form-group">
                        <label><?php echo $this->lang->line('blog_category_description');?></label>
                        <textarea id="category_description" name="category_description" class="ckeditor" placeholder="<?php echo $this->lang->line('blog_category_description_placeholder');?>"><?php echo set_value('category_description');?></textarea>
                      </div>
                      ...
                      <div class="tab-pane fade" id="blog_category_settings"><!--Starts Blog Category Settings Tab Content -->       
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" id="category_slug" name="category_slug" value="<?php echo set_value('category_slug');?>" class="form-control input-lg m-b" placeholder="<?php echo $this->lang->line('blog_category_slug_placeholder');?>">
                        </div>
