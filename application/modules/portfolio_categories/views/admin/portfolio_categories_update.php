          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('update_portfolio_category');?></h3>
              </div>   
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-info"><?php echo $this->lang->line('update_portfolio_category');?></div>
                      </div>                    
                    </div>
                  </div>
              ...
              <div class="col-lg-8">
               <!--Portfolio Category Information Form Panel -->
               <section>
                <div class="panel-body">
                  <div class="tab-content"><!--Starts Tab Content -->

                    <div class="tab-pane fade active in" id="portfolio_category"><!--Starts Portfolio Category Tab Content -->
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="portfolio_category_title" name="portfolio_category_title" value="<?php echo set_value('portfolio_category_title', $category->portfolio_category_title);?>" class="form-control input-lg m-b" placeholder="<?php echo $this->lang->line('blog_category_title_placeholder');?>">
                      </div>
                      <div class="line line-dashed line-lg pull-in"></div>

                      <div class="form-group">
                        <label><?php echo $this->lang->line('blog_category_description');?></label>
                        <textarea id="portfolio_category_description" name="portfolio_category_description" class="ckeditor" placeholder="<?php echo $this->lang->line('portfolio_category_description_placeholder');?>"><?php echo set_value('portfolio_category_description', $category->portfolio_category_description);?></textarea>
                      </div>

                    </div>

                    <div class="tab-pane fade" id="portfolio_category_settings"><!--Starts Portfolio Category Settings Tab Content -->       
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="portfolio_category_slug" name="portfolio_category_slug" value="<?php echo set_value('portfolio_category_slug', $category->portfolio_category_slug);?>" class="form-control input-lg m-b" placeholder="<?php echo $this->lang->line('blog_category_slug_placeholder');?>">
                      </div>
                    ...
                    <div class="tab-pane fade" id="logging_settings"><!--Starts logging Settings Tab Content -->
                      ...
                      <div class="form-group">
                        <label for="seo_page_title"><i class="fa fa-credit-card fa-2x text-success"></i> <?php echo $this->lang->line('portfolio_category_id');?></label>
                      ...
                      <div class="form-group">
                        <label for="seo_page_title"><i class="fa fa-calendar-o fa-2x text-success"></i> <?php echo $this->lang->line('portfolio_category_created_date');?></label>
                        <p class="help-block"><?php echo $category->created ?></p>
                      </div>

                      <div class="form-group">
                        <label for="seo_page_title"><i class="fa fa-user fa-2x text-success"></i> <?php echo $this->lang->line('portfolio_category_created_by');?></label>
                      ...
                      <div class="form-group">
                        <label for="seo_page_title"><i class="fa fa-calendar-o fa-2x text-success"></i> <?php echo $this->lang->line('portfolio_article_updated_date');?></label>
                        <p class="help-block"><?php echo $category->modified ?></p>
                      </div>

                      <div class="form-group">
                        <label for="seo_page_title"><i class="fa fa-user fa-2x text-success"></i> <?php echo $this->lang->line('portfolio_article_updated_by');?></label>
