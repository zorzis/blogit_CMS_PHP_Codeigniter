          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('manage_trashed_portfolio_categories');?></h3>
              </div>
				                  ...
				                  <table class="table table-striped b-t b-light">
				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
				                        		<a onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" href="<?php echo base_url(); ?>admin/portfolio/categories/delete_trashed_portfolio_category/<?php echo $category->id ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
											</td>
