...
class Portfolio_categories_m extends MY_Model{
    ...
    // Function to show all published/unpublished portfolio categories
 	public function get_portfolio_categories(){
        $this->db->select('a.*');
        $this->db->from('portfolio_categories AS a');
    ...
    // Function to show trashed portfolio categories with is_published status = 2 same with get_articles function
 	public function get_trashed_portfolio_categories(){
    	$this->db->select('a.*');
		$this->db->from('portfolio_categories AS a');
