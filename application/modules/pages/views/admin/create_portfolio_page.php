            ...
            <section class="scrollable wrapper">
              ...
              <div class="col-lg-4">
                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-info"><?php echo $this->lang->line('create_portfolio_page');?></div>
                      </div>                      
                    </div>
                  </div>
                ...
                <a class="btn btn-info btn-lg btn-block" href="#page_settings" data-toggle="tab">
                  ...
                  <?php echo $this->lang->line('portfolio_page_settings');?>
                </a>
                      ...
                      <div class="tab-pane fade active in" id="page_settings">
                        ...
                        <section class="panel panel-default">
                          <header class="panel-heading bg-warning lt no-border font-bold">
                            <i class="fa fa-bars fa-2x"> <?php echo $this->lang->line('portfolio_page_settings');?></i>
                          </header>
                        </section>
