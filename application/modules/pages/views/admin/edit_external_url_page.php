                  ...
                  <div class="panel-body">
                    <div class="clearfix text-center m-t">
                      <div class="inline">
                        ...
                        <div class="h1 m-t m-b-xs text-info"><?php echo $this->lang->line('update_external_url_page');?></div>
                      </div>                      
                    </div>
                  </div>
                    ...
                    <div class="tab-content"><!--Starts Tab Content -->             
                      <div class="tab-pane fade active in" id="page_settings">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" id="external_url" name="external_url" value="<?php echo set_value('external_url', $page->external_url);?>" class="form-control input-lg m-b" placeholder="<?php echo $this->lang->line('external_url_placeholder');?>">
                        </div>
