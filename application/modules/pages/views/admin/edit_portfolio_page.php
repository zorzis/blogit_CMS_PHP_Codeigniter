                    ...
                    <div class="row pull-out">
                      ...
                      <div class="col-xs-4 dk">
                        <div class="padder-v">
                          ...
                          <span class="m-b-xs h4 block <?php echo ($page->is_published == 1) ? "text-success" : "text-danger";?>"><?php echo ($page->is_published == 1) ? "ON" : "OFF";?></span>
                      ...
                      <div class="tab-pane fade active in" id="page_settings">
                        ...
                        <section class="panel panel-default">
                          <header class="panel-heading bg-warning lt no-border font-bold">
                            <i class="fa fa-bars fa-2x"> Portfolio Page Settings </i>
                          </header>
                        </section>
                        ...
                        <div class="form-group">
                          ...
                          <label><?php echo $this->lang->line('page_select_portfolio_categories');?></label>

                          <select name="page_categories[]"  multiple class="form-control input-lg m-b">

                            <?php foreach ($page_portfolio_categories_selection as $page_category) : ?>

                            <option value="<?php echo $page_category->id; ?>" 

                              <?php echo set_select('page_categories',$page_category->id); ?>

                              <?php 

                              if(in_array($page_category->id,$selected_portfolio_categories)) 
                              {
                                echo 'selected';
                              }
                              ?>
                              ...
                              <?php echo $page_category->portfolio_category_title; ?>
                        ...
                        <p class="help-block"><?php echo $this->lang->line('page_select_portfolio_categories_helper');?></p>
