          <section class="vbox">
            ...
            <section class="scrollable wrapper">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none"><?php echo $this->lang->line('manage_pages');?></h3>
              </div>
				<section class="panel panel-default">
				                <header class="panel-heading">
				                	<i class="fa fa-bars fa-2x"> <?php echo $this->lang->line('pages');?></i>
				                  ...
				                  <table class="table table-striped b-t b-light">
				                    <thead>
				                      <tr>
				                        ...
				                        <th><?php echo $this->lang->line('page_is_home');?></th>
				                    ...
				                    <tbody>
										...
										<tr>
											...
											<td>
												...
												<span class="<?php echo ($page->is_home == 1) ? "label bg-primary" : "";?> "> <?php echo ($page->is_home == 1) ? "Homepage" : "";?> </span>
											...
											<td>
												...
												<span class="label <?php echo ($page->is_published == 1) ? "bg-success" : "bg-danger";?>"> <?php echo ($page->is_published == 1) ? "Published" : "Unpublished";?> </span>
											...
											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/pages/set_home_page/<?php echo $page->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('page_tooltip_set_home');?>"><i class="fa fa-home text-primary"></i></a>
											</td>
											...
											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/pages/unpublish_page/<?php echo $page->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Unpublish"><i class="fa fa-circle text-danger"></i></a>
											</td>

											<td>
				                        		<a type="text" href="<?php echo base_url(); ?>admin/pages/delete_page/<?php echo $page->id ?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Trash"><i class="fa fa-trash-o text-warning"></i></a>
											</td>
