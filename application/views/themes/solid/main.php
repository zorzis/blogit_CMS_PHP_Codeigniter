...
<html lang="en">
  <head>
	...
	<meta name="author" content="blogit cms">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <?php if(is_file('uploads/' . $settings->logo_image)) : ?>
          	...
          	<a class="navbar-brand" href='<?php echo base_url(); ?>'><img src="<?php echo base_url(); ?>uploads/<?php echo $settings->logo_image; ?>" alt="<?php echo $settings->webpage_title?>" width="50px" height="50px"></a>

          <?php else: ?>

          	<a class="navbar-brand" href='<?php echo base_url(); ?>'><?php echo $settings->webpage_title?></a>
