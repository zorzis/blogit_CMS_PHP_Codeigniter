...
<!-- *****************************************************************************************************************
	 TITLE & CONTENT
	 ***************************************************************************************************************** -->
<?php echo $this->load->get_section('after_header_3_title_and_content'); ?>
							...
							<?php if ($media->project_id == $project->id): ?>
								...
								<div class="he-view">
									<div class="bg a0" data-animate="fadeIn">
		                                ...
		                                <a href="<?php echo site_url(); ?><?php echo $page->slug; ?>/<?php echo $project->category_slug ?>/project/<?php echo $project->id; ?>/<?php echo $project->project_slug; ?>" class="dmbutton a2" data-animate="fadeInUp"><i class="fa fa-link"></i></a>
		                        	</div><!-- he bg -->
								</div><!-- he view -->	
