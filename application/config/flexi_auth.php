...
*/
	...
	*/ 
	...
	//is_frontend_priv is used by blogit cms to seperate privileges that are used for frontend use only.
	$config['database']['user_privileges']['columns']['is_frontend_priv'] = 'upriv_is_frontend';
