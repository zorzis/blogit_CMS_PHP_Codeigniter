...
class Auth extends CI_Controller {
    ...
    function __construct() 
    {
		...
		// Sets the function for the template using in the login/registration etc in above code
		$this->_init();
	}
	...
	/* ---------- Initializes the Admin Template Structure-------------------*/
		...
		{
			$this->output->set_template('admin_themes/auth');
	...
	*/
    ...
    {	
		...
		$this->load->view('themes/admin_themes/login', $this->data);
    }
